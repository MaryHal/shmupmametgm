...
const options_entry mame_core_options[] =
{
	...
	{ "fumen",                       "0",         OPTION_BOOLEAN,    "enable fumen tetromino logger for tgm2p (this will also enable the cheat subsystem)" },
	{ "taptracker",                  "0",         OPTION_BOOLEAN,    "enable taptracker for tgm2p (this will also enable the cheat subsystem)" },
